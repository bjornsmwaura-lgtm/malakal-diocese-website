      ...
      <div className="app">
        ...
        <main>
          <Routes>
            ...
            />
            <Route 
              path="/deaneries/northern-deanery/st-paul-the-apostle-kaka" 
              element={<StPaultheApostleKaka />} 
            />

            {/* Southern Deanery Parishes */}
            <Route 
              path="/deaneries/southern-deanery/all-saints-waat" 
              element={<AllSaintsWaat />} 
            />
            <Route 
              path="/deaneries/southern-deanery/ascension-of-the-lord-ayod" 
              element={<AscensionOfTheLordAyod />} 
            />
            <Route 
              path="/deaneries/southern-deanery/holy-trinity-fangak" 
              element={<HolyTrinityFangak />} 
            />
            <Route 
