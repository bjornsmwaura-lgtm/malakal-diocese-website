...
export const liturgyData = {
  ...
  cards: [
    ...
    {
      id: 3,
      title: "Liturgical Calendar & Resources",
      description: "The office publishes the diocesan liturgical calendar, provides resources for seasons such as Advent, Lent, and Easter, and assists parishes in implementing liturgical norms and guidelines.",
      image: "/images/curia/liturgy/liturgy4.jpeg",
      alt: "Liturgical calendar and resources"
    }
  ],
  contact: {
    email: "liturgy@malakaldiocese.org",
    phone: "+211 912 345 682",
    location: "Liturgy Office, Curia, Malakal",
