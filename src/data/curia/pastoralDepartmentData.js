// src/data/curia/pastoralDepartmentData.js

export const pastoralDepartmentData = {
  header: {
    title: "Pastoral Department",
    subtitle: "Nurturing the Spiritual Life of the Diocese",
    description: "The Pastoral Department coordinates all spiritual activities, catechetical programs, and lay formation initiatives across the Diocese of Malakal, guiding the faithful in their journey of faith.",
    image: "/images/curia/pastoral/catechists4.jpeg",
    badge: "Curia"
  },
  description: `The Pastoral Department of the Catholic Diocese of Malakal is committed to nurturing the spiritual growth and development of all the faithful. Guided by the Gospel of Jesus Christ and the teachings of the Catholic Church, we strive to create a vibrant, faith-filled community that responds to the needs of our time.

**Our Mission:** To coordinate and support pastoral activities across the diocese, ensuring that the message of Christ reaches every corner of our communities through effective evangelization, catechesis, and pastoral care.

**Our Vision:** A diocese where every Catholic is actively living their faith, participating in the life of the Church, and contributing to the building of God's Kingdom on earth.`,
  pastoralPriorities: [
    {
      id: 1,
    ...
    },
    {
      ...
      description: "Providing healthcare services and health education to communities, recognizing the healing ministry of Christ as an integral part of the Church's mission."
    },
    {
      id: 10,
      title: "Care for Church Workers",
      description: "Educating Catholic communities to take care of their Priests, Sisters, and Catechists, ensuring that those who dedicate their lives to serving the Church are supported and valued."
    }
  ],
  contact: {
    email: "pastoral@malakaldiocese.org",
    phone: "+211 912 345 681",
    location: "Pastoral Department, Curia, Malakal",
