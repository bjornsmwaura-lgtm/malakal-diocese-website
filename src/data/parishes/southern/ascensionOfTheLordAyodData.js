// src/data/parishes/southern/ascensionOfTheLordAyodData.js

export const ascensionOfTheLordAyodData = {
  header: {
    title: "Ascension of the Lord Ayod",
    subtitle: "Patron Saint: Ascension of the Lord",
    description: "A parish under the patronage of the Ascension of the Lord, serving the Catholic community in Ayod.",
    image: "/images/parishes/ascension-of-the-lord-ayod-header.jpg"
  },
  history: {
...
description: "A Catholic school providing quality education and holistic formation, nurturing students academically, morally, and spiritually while preparing them to become responsible and active members of society. Comboni was established in the year 1998."
  ...
  contact: {
    email: "ascension.ayod@malakaldiocese.org",
    phone: "+211 [Phone Number]",
    location: "Ascension of the Lord Parish, Ayod, South Sudan",
