// src/data/parishes/northern/christTheKingRenkData.js

export const christTheKingRenkData = {
  header: {
    title: "Christ the King Renk",
    subtitle: "Patron Saint: Christ the King",
    description: "A parish dedicated to Christ the King, serving the Catholic community in Renk.",
    image: "/images/pageheaders/christ-the-king-renk-header2.jpg"
  },
  history: {
    priestImage: "/images/parishpriests/fr-jane-smith.jpg",
    priestName: "Msgr. Roko Taban Musa",
    description: "Renk is located on the eastern bank of the River Nile in the northern part of Upper Nile State. Originally inhabited by the Dinka Abeliank, it has become a metropolitan area with different tribes and foreigners co-existing, and it serves as a transit corridor between Sudan and South Sudan through the Joda border.The Christian community in Renk began in 1964 through the initiative of local Christians. Early prayers were held in homes and later in a simple shelter (rakuba). In 1965, Monsignor Pio Yukwan vsited, blessed the place, celebrated Holy Mass, and declared it a centre for prayers. Due to war and long distance, administration was supported by the Archdiocese of Khartoum, sending catechists and occasional priests, while sisters started staying in Renk in 1988. On 21st January 1992, the parish was officially inaugurated. It has since been served by several priests, deacons, and seminarians. On 5th November 2023, the parish was handed over to the Catholic Diocese of Malakal, and Monsignor Roko Taban Mousa was appointed Parish Priest, assisted by Fr. Michael Kiragu Njuguna."
  },
...
description: "A Catholic school providing quality education and holistic formation, nurturing students academically, morally, and spiritually while preparing them to become responsible and active members of society. Comboni was established in the year 1998."
  ...
  parishDetails: {
    ...
    parishPriest: "Msgr. Roko Taban Musa",
    otherPriests: "Rev. Fr. Michael Njuguna",
    sisters:" Comboni Sisters"
  },
  massSchedules: {
    sundays: ["8:00 AM - English", "10:00 AM - Arabic", ],
    weekdays: ["6:25 AM - English", "5:00 PM - Adoration - Fridays","9:00 AM - Saturday Mass in the prison" ]
  },
  contact: {
    email: "christtheking.renk@malakaldiocese.org",
    phone: "+211 911747089 / +21122570999",
    location: "Christ the King Parish, Renk, South Sudan",
